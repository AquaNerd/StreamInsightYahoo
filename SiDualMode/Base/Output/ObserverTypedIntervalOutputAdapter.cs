...
namespace SiDualMode.Base.Output {
    public class ObserverTypedIntervalOutputAdapter<TPayloadType> : TypedIntervalOutputAdapter<TPayloadType> {
        private readonly IObserver<IntervalEvent<TPayloadType>> _sinkObserver;
        private object _monitorObject = new object();

        public ObserverTypedIntervalOutputAdapter(IObserver<IntervalEvent<TPayloadType>> sinkObserver) {
        ...
        private void EmptyQueue() {
            IntervalEvent<TPayloadType> dequeuedEvent;
