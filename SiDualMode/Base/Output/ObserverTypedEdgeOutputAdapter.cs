...
namespace SiDualMode.Base.Output {
    public class ObserverTypedEdgeOutputAdapter<TPayloadType> : TypedEdgeOutputAdapter<TPayloadType> {
        private readonly IObserver<EdgeEvent<TPayloadType>> _sinkObserver;
        private object _monitorObject = new object();

        public ObserverTypedEdgeOutputAdapter(IObserver<EdgeEvent<TPayloadType>> sinkObserver) {
        ...
        private void EmptyQueue() {
            EdgeEvent<TPayloadType> dequeuedEvent;
